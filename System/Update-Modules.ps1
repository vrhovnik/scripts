...
Updates all the modules on the system
  
.DESCRIPTION
  
Updates all the modules on the system - this script is available on https://powershellisfun.com and all the code is 
