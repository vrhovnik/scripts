<#
    ...
    Method is based on the following code - all copyrights to the author of this repository: https://github.com/HCRitter/Get-WIFIPassword/blob/master/Get-WIFIPassword.ps1

    .EXAMPLE
    Get-WIFIPassword

    .LINK
    https://github.com/HCRitter/Get-WIFIPassword/blob/master/Get-WIFIPassword.ps1
#>
